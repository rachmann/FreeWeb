...
namespace FreeWeb.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public ManageController(FreeAppUserManager userManager)
        {
        ...
        public FreeAppUserManager UserManager
        {
            get
            {
                return _userManager ?? HttpContext.GetOwinContext().GetUserManager<FreeAppUserManager>();
            }
            private set
            {
                _userManager = value;
...
#region Helpers
        ...
        private async Task SignInAsync(FreeAppUser user, bool isPersistent)
        {

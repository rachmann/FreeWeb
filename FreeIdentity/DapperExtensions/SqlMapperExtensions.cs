...
namespace FreeIdentity.DapperExtensions
{
        ...
        public static long Insert<T>(this IDbConnection connection, T entityToInsert, IDbTransaction transaction = null, int? commandTimeout = null) where T : class
        {
            ...
            if (entityToInsert != null)
            {
                using (var tx = connection.BeginTransaction())
                {
                    ...
                    var id = connection.ExecuteScalar<long>(sb.ToString(), entityToInsert, transaction: transaction == null ? tx : transaction, commandTimeout: commandTimeout);
                    if (transaction == null)
                        tx.Commit();
                    resultId = id;
                }
